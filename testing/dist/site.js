...
/* harmony export */ });
/* harmony import */ var _animations_Animate_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animations/Animate.js */ "../animations/Animate.js");
/* harmony import */ var _animations_AnimateText_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./animations/AnimateText.js */ "../animations/AnimateText.js");
/* harmony import */ var _animations_Draw_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./animations/Draw.js */ "../animations/Draw.js");
/* harmony import */ var _animations_Magnetic_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./animations/Magnetic.js */ "../animations/Magnetic.js");
/* harmony import */ var _animations_Revealer_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./animations/Revealer.js */ "../animations/Revealer.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  Alpine.data('animate', _animations_Animate_js__WEBPACK_IMPORTED_MODULE_0__["default"]);
  Alpine.data('animateText', _animations_AnimateText_js__WEBPACK_IMPORTED_MODULE_1__["default"]);
  Alpine.data('draw', _animations_Draw_js__WEBPACK_IMPORTED_MODULE_2__["default"]);
  Alpine.data('magnetic', _animations_Magnetic_js__WEBPACK_IMPORTED_MODULE_3__["default"]);
  Alpine.data('revealer', _animations_Revealer_js__WEBPACK_IMPORTED_MODULE_4__["default"]);
  window.avalanche = {
    loaded: false,
    delay: {
      "default": 0.25,
    ...
    breakpoint: function breakpoint(width) {
      var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'min';
      var dimension = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'width';
      if (type === 'max') {
        width--;
      }
      return "(".concat(type, "-").concat(dimension, ": ").concat(width, "px)");
    },
    inView: function inView(el) {
      ...
      if (Alpine.store('barba')) {
        if (Alpine.store('barba').started && Alpine.store('barba').currentHeight) {
          var pageScrolled = window.scrollY;
          var offset = Alpine.store('barba').currentHeight - pageScrolled;
          top = rect.top - offset;
        }
      }
      top = Math.round(top);
    ...
    setTrigger: function setTrigger(container, component) {
    ...
    error: {
      ...
      inView: function inView() {
        console.error("".concat(this.root, " inView is missing an triggger! \uD83D\uDE31"));
      },
      element: function element($el) {
        console.error("".concat(this.root, " A ").concat($el, "() animation has no element to animate!"));
      },
      trigger: function trigger($el) {
        console.error("".concat(this.root, " A ").concat($el, "() animation has no trigger set! \uD83D\uDE31"));
      }
    }
  };
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  return {
    ...
    animate: function animate() {
      ...
      tl.addLabel('start');
      var animations = [this.opacity, this.rotation, this.scale, this.scaleX, this.scaleY, this.x, this.y, this.xPercent, this.yPercent];
      animations.forEach(function (animation) {
        _this.set(animation, tl);
      });
    },
    watch: function watch(item) {
      var _this2 = this;
      this.$watch(item, function (value) {
        value ? _this2.active() : _this2.inactive();
      });
    },
    active: function active() {
      opacity = _objectSpread(_objectSpread({}, opacity), {}, {
        start: 0,
        end: 1
      });
    },
    ...
    setTrigger: function setTrigger(container) {
      avalanche.setTrigger(container, this);
    },
    set: function set(animation, tl) {
      var _animation$stagger, _animation$repeat;
      ...
      if (animation == this.opacity) {
        ...
        from = {
          scaleX: animation.start
        };
        to = {
          scaleX: animation.end
        };
      } else if (animation == this.scaleY) {
        from = {
          scaleY: animation.start
        };
        to = {
          scaleY: animation.end
        };
        ...
        from = {
          xPercent: animation.start
        };
        to = {
          xPercent: animation.end
        };
      } else if (animation == this.yPercent) {
        from = {
          yPercent: animation.start
        };
        to = {
          yPercent: animation.end
        };
      }
      tl.fromTo(this.element, from, _objectSpread(_objectSpread({}, to), {}, {
        stagger: (_animation$stagger = animation.stagger) !== null && _animation$stagger !== void 0 ? _animation$stagger : this.stagger,
        repeat: (_animation$repeat = animation.repeat) !== null && _animation$repeat !== void 0 ? _animation$repeat : 0,
  ...
  return {
    ...
    mounted: function mounted() {
      ...
      if (this.type === 'lines') {
        ...
        this.splitText.type = "".concat(this.type, ", lines");
      } else if (this.type === 'chars') {
        this.splitText.type = "".concat(this.type, ", words, lines");
    ...
    animate: function animate() {
      var _this = this;
      var split = SplitText.create(this.element, _objectSpread(_objectSpread({}, this.splitText), {}, {
        onSplit: function onSplit(self) {
          var tl = gsap.timeline({
            delay: _this.delay,
            scrollTrigger: _this.scrollSettings
          });
          if (_this.type === 'lines') {
            _this.text = self.lines;
          } else if (_this.type === 'words') {
            _this.text = self.words;
          } else if (_this.type === 'chars') {
            _this.text = self.chars;
          }
          gsap.set(_this.element, {
            autoAlpha: 1
          });
          tl.addLabel('start');
          var animations = [_this.opacity, _this.rotation, _this.scale, _this.scaleX, _this.scaleY, _this.x, _this.y, _this.xPercent, _this.yPercent];
          animations.forEach(function (animation) {
            _this.set(animation, tl);
          });
        }
    ...
    set: function set(animation, tl) {
      ...
      tl.fromTo(this.text, from, _objectSpread(_objectSpread({}, to), {}, {
        stagger: (_animation$stagger = animation.stagger) !== null && _animation$stagger !== void 0 ? _animation$stagger : this.stagger,
        repeat: (_animation$repeat = animation.repeat) !== null && _animation$repeat !== void 0 ? _animation$repeat : 0,
        duration: animation.duration,
        ease: animation.ease
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  ...
  return {
    ...
    magnetize: function magnetize(ev, item, element, force) {
...
/* harmony import */ var _Avalanche__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Avalanche */ "../Avalanche.js");
...
gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.registerPlugin(gsap_DrawSVGPlugin__WEBPACK_IMPORTED_MODULE_3__.DrawSVGPlugin, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_5__.ScrollTrigger, gsap_ScrollToPlugin__WEBPACK_IMPORTED_MODULE_4__.ScrollToPlugin, gsap_SplitText__WEBPACK_IMPORTED_MODULE_6__.SplitText);
window.gsap = gsap__WEBPACK_IMPORTED_MODULE_2__.gsap;
window.mm = gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.matchMedia();
gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_5__.ScrollTrigger.normalizeScroll(true);
window.ScrollTrigger = gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_5__.ScrollTrigger;
window.SplitText = gsap_SplitText__WEBPACK_IMPORTED_MODULE_6__.SplitText;
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].store('barba', {
  currentHeight: 0,
  started: false
});
(0,_Avalanche__WEBPACK_IMPORTED_MODULE_1__["default"])();
